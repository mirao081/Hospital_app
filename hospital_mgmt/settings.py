...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-default-key-for-dev")  # Use env var in prod
...
MIDDLEWARE = [
    ...
    'core.middleware.AccessLogMiddleware',  # Your custom middleware
]
...
# Database
# Default SQLite, use DATABASE_URL env variable for Postgres in production
DATABASES = {
    'default': {
